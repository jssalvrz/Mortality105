...
# FEMALES
ciFem <- ciUSA(qxMat = qxMat.f, Age = nages,nx = 0.5)
# MALES
ciMen <- ciUSA(qxMat = qxMat.m, Age = nages,nx = 0.5)
# TOTAL
ciTot <- ciUSA(qxMat = qxMat.t, Age = nages,nx = 0.5)
...
save(ciFem,ciMen, file = "ciUSA5.RData")
